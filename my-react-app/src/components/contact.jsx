...
export default function Contact() {
    return (
        <div style={{ padding: '2rem', backgroundColor: '#D5D5D5' }}>
            ...
            <p style={style.p}>Visit our sister companies<span style={{color:"rgba(255, 105, 0, 1)"}} > Home Sound </span>and <span style={{color:"rgba(255, 105, 0, 1)"}}>The Movie Rooms</span> part of the HiFi Horizon Group. </p>
        </div>
    );
}