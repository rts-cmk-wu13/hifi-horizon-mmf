    ...
    <>
      ...
      >
        ...
        <section>
          ...
          <p>
            product reaches us. Shipping costs are non-refundable. If you
            receive a refund, the cost of return shipping will be deducted from
            your refund. Depending on
          </p>
          <p>
            where you live, the time it may take for your exchanged product to
            reach you may vary. We will process the refund when the item arrives
            with us.
          </p>
          <br />
          <p>
        ...
        <section>
          ...
          <p>
            ...
            is a problem we would like
          </p>
          <p>
            to deal with this as soon as possible to alleviate any inconvenience
            to yourself.
          </p>
          <p>
            As soon as we have delivered the goods to you, you will be
            responsible for them and any damage occasioned whilst in your
            possession. The majority of goods
          </p>
          <p>
          ...
          <p>
            ...
            tried to delivery the goods to
          </p>
          <p>
            you. If your product is visibly damaged in transit, please sign for
        ...
        <section>
          ...
          <p>
            refund you the cost of your order, excluding postage or delivery
            cost. However, if goods are not returned "as new" due to excessive
            handling on your part, or{" "}
          </p>
          <p>
          ...
          <p>
            ...
            that you include your receipt or proof of purchase and a cover
            letter detailing briefly{" "}
          </p>
          <p>
            why the item is being returned. We cannot refund the cost of
            delivery fees if there was an additional charge, only the cost of
            the goods themselves. We will{" "}
          </p>
          <p>
            process the refund when the item arrives with us. If you are
            shipping an item over £100, we would advise using a trackable
            shipping service or purchasing{" "}
          </p>
          <p>
            shipping insurance. We cannot guarantee that we will receive your
            returned item.
          </p>
          <br />
          <p>
